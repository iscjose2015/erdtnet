...
<table width="100%" border="1">
  ...
  <tr>
    <td>Referencia</td>
    <td><?php echo $re_orden[referencia]; ?></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>Monto</td>
    <td><?php echo $re_orden[total_venta]; ?></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
...
<p></p>
  ...
  <table id="example1" class="table table-bordered table-striped">
                  ...
                  $consulta_detalle = mysqli_query($cone,"select * from detalle_fact_provee where idfactura = '$fa'");
