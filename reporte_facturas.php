...
<section class="content-header">
  ...
  <form id="form1" name="form1" method="get" action="reporte_facturas_excel.php">

  <div class="col-sm-3">
  <label>Fecha de inicio </label>
  <input type="date" name="txtinicio" id="txtinicio" class="form-control" required="required" />
  <label>Fecha de termino </label>
  <input type="date" name="txtfin" id="txtfin" class="form-control" required="required" />
