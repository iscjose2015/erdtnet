...
$sql = mysqli_query ($cone, "SELECT id_producto, codigo_producto, nombre_producto, id_sat, nom_sat, unidad_sat, peso, idfamilia, familia 
FROM products limit 1000");
//$sql = "SELECT * FROM products";13950
...
while($data = mysqli_fetch_array($sql)){
	...
	$nomProduc  = str_replace('"', '', $nomProduc);
	$idSat		= $data['id_sat'];
	$nomSat		= $data['nom_sat'];
