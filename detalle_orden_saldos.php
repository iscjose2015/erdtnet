      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <div class="col-sm-6">
            <h3><a href="reporte_saldo_facturas.php">Volver Reporte Saldo Facturas</a></h3>
            </div>
          </div>
          <div class="col-sm-6">
  ...
  <table width="2296" border="1" align="center">
                  ...
                  <tr>
                    ...
                    <td align="center" valign="top" class="letrachica">$<?php echo  $valor_soli = number_format(($re['monto'] * $re['inicial']) / 1000 ,2);
					    $suma_valor_solicitado =  $suma_valor_solicitado + $valor_soli;
...
<table width="2296" border="0">
  <tr>
    ...
    <td width="68">&nbsp;</td>
    <td width="52">&nbsp;</td>
    <td width="78" align="center">$<?php echo $suma_valor_solicitado; ?></td>
    <td width="67">&nbsp;</td>
    <td width="48">&nbsp;</td>
    <td width="154">&nbsp;</td>
    <td width="99">&nbsp;</td>
    ...
    <td width="149" align="center" valign="top" bgcolor="#999999"><em><strong>&nbsp;
      <?php  echo "<h3>". round($suma_total,2)."</h3>"; ?>
    </strong></em></td>
    <td width="129">&nbsp;</td>
    <td width="144">&nbsp;</td>
    <td width="147">&nbsp;</td>
