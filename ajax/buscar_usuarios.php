<?php
	...
	if (isset($_GET['id']) and $_GET['id']!=0){
		...
		if ($user_id!=1){
			...
			?>
			<div class="alert alert-danger alert-dismissiblemy-2" role="alert">
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><a href="permisos.php?cve=<?php echo $user_id; ?>"><?php echo $fullname; ?></a></td>
					...
					<div class="btn-group" role="group" aria-label="Basic example">
					  <a href="#" class='btn btn-secondary' title='Editar usuario' data-bs-toggle="modal" data-bs-target="#editModal" data-bs-id="<?=$user_id;?>" data-bs-nombres="<?=$row['firstname'];?>" data-bs-apellidos="<?=$row['lastname'];?>" data-bs-email="<?=$user_email;?>" data-bs-usuario="<?=$user_name;?>" ><i class="bi bi-pencil"></i></a> 
					  <a href="#" class='btn btn-secondary' title='Cambiar contraseña' data-bs-toggle="modal" data-bs-target="#editModalPass" data-bs-id="<?=$user_id;?>" ><i class="bi bi-gear"></i></a> 
					  <a href="#" class='btn btn-danger' title='Borrar usuario' onclick="eliminar('<?php echo $user_id; ?>')"><i class="bi bi-trash"></i> </a>
					</div>
