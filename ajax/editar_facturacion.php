...
if (isset($_GET['id']) and $_GET['id']!=0)//codigo elimina un elemento de la base de datos
{
...
<?php
	...
	$sumador_total+=$precio_total_r;//Sumador
		...
		<tr>
			...
			<td class='text-end'><?php echo $precio_venta_f;?></td>
			<td class='text-end'><?php echo $precio_total_f;?></td>
			<td class='text-center'><a href="#" onclick="eliminar('<?php echo $id_detalle ?>')"><i class="bi bi-trash danger"></i></a></td>
		</tr>		
		<?php
	}
...
?>
<tr>
	<td class='text-end' colspan=4>SUBTOTAL <?php echo $simbolo_moneda;?></td>
	<td class='text-end'><?php echo number_format($subtotal,2);?></td>
	<td></td>
</tr>
<tr>
	<td class='text-end' colspan=4>IVA (<?php echo $impuesto;?>)% <?php echo $simbolo_moneda;?></td>
	<td class='text-end'><?php echo number_format($total_iva,2);?></td>
	<td></td>
</tr>
<tr>
	<td class='text-end' colspan=4>TOTAL <?php echo $simbolo_moneda;?></td>
	<td class='text-end'><?php echo number_format($total_factura,2);?></td>
	<td></td>
</tr>
