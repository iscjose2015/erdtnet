			  ...
			  <table class="table ">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<div class="btn-group" role="group" aria-label="Basic example">
					  <a href="#" class='btn btn-secondary' title='Editar cliente' data-bs-toggle="modal" data-bs-target="#editModal" data-bs-id="<?=$id_cliente;?>" data-bs-cliente="<?=$nombre_cliente;?>" data-bs-telefono="<?=$telefono_cliente;?>" data-bs-estado="<?=$status_cliente;?>" data-bs-email="<?=$email_cliente;?>" data-bs-direccion="<?=$direccion_cliente;?>" ><i class="bi bi-pencil"></i></a> 
					  <a href="#" class='btn btn-danger' title='Borrar cliente' onclick="eliminar('<?php echo $id_cliente; ?>')"><i class="bi bi-trash"></i> </a>
					</div>
