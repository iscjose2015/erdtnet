		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                if ($query_check_user == 1) {
                    ...
                    $consulta = mysqli_query($con,"select * from users where user_name = '$user_name'");
                    $re_consulta = mysqli_fetch_array($consulta);

                    $id_user = $re_consulta['user_id'];


                    $inserta_permisos = mysqli_query($con,"INSERT INTO `permisos` (`id`, `idempleado`, `clientes`, `configuracion`, `empresas`, `facturas`, `ordenes`, `productos`, `proveedores`, `usuarios`) 
                    VALUES (NULL, '$id_user', '0', '0', '0', '0', '0', '0', '0', '0');");
