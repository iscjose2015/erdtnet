            ...
            <div class="row g-2"><!-- INICIA SECCION 3--->
              ...
              <div class="col-sm-5 col-md-6">
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input type="number" name="txtsaldAnt" id="txtsaldAnt" class="form-control" placeholder="" >
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-5 col-md-6">
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input type="number" name="txtimportPgo" id="txtimportPgo" class="form-control" placeholder="" >
                      </div>
                  </div>
              </div>
            ...
            <div class="row g-2"><!-- INICIA SECCION 4--->
              ...
              <div class="col-sm-5 col-md-6">
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input type="number" name="txtfolio" id="folio-input" class="form-control" placeholder="Ejemplo 9999" >
                      </div>
                  </div>
              </div>
