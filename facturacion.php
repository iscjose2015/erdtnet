  ...
  if ($_GET[f] == 'n'){
	...
	if (!isset($_SESSION['user_login_status']) AND $_SESSION['user_login_status'] != 1) {
        ...
        if($_GET[opc] == 1){
			...
			if ($rel == 'SIAVCOM') { $rel = $_GET[txtuuidsiavcom];}
          ...
          //  echo "Aqui la seleccionada".$sel;
           ...
           // echo "Emisor".$emisor;
            ...
            `uso`, `estatus`, `tipo_cfdi`, `folio`, `serie`, `hora`, `emisor`, `moneda`, `lugar`, `total`, `pedimento`, `relacionado`, `tiporelacionado`, `tipocambio`) 
            VALUES (NULL, '$fech', '', '$emi', '$for', '$met', '$us', 'Por Emitir', '$tip', '', '$ser', '$hor','$emisor','$mon','$lug','0','$ped','$rel','$tipor','$tipoc');");
...
<input type="text" class="form-control" id="txtpedimento" placeholder="Pedimento 15 caracteres" name="txtpedimento"  value="" minlength="15"  maxlength="15" >
</div>

<div class="col-2">
Tipo Cambio
<label for="lblpedimento"></label>
<input type="text" class="form-control" id="txttipoc" placeholder="Tipocambio" name="txttipoc"  value="1"  >
</div>
...
<option value=""></option>
<option value="SIAVCOM">SIAVCOM</option>
  <?php
...
<div class="col-sm-6 ">
  <!-- este es un espacio -->  
        ...
        <p><span class="col-6">Factura SIAVCOM <span class="col-2">
        <input type="text" class="form-control" id="txtuuidsiavcom" placeholder="UUID" name="txtuuidsiavcom"  value=""  >
        </span></span></p>         
