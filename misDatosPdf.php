...
<table width="493" class="chica2">
  <thead>
    <tr>
      <th width="43" bgcolor="#CCCCCC"><em><strong>Cantidad</strong></em></th>
      <th width="42" bgcolor="#CCCCCC"><em><strong>Unidad</strong></em></th>
      <th width="42" bgcolor="#CCCCCC"><em><strong>Codigo Sat</strong></em></th>
      <th width="52" bgcolor="#CCCCCC"><em><strong>Clave</strong></em></th>
      <th width="167" bgcolor="#CCCCCC"><em>Descripci&oacute;n</em></th>
      <th width="46" bgcolor="#CCCCCC"><em>Precio</em></th>
      <th width="106" bgcolor="#CCCCCC"><em>Importe</em></th>
    </tr>
  </thead>
  <tbody>
    <?php
				...
				?>
    <tr class="chica1">
      <td align="left"><?php echo number_format($red['cantidad']); ?></td>
...
<table width="492"   class="chica2">
  <tbody>
    <tr>
      ...
      <td width="54">&nbsp;</td>
      <td width="79">&nbsp;</td>
      <td width="129" align="right"><em><strong>Subtotal:</strong></em></td>
      <td width="72" align="right"><em><strong>$<?php echo number_format(saber_total_factura($clave),2);
