  ...
  if($re_consulta[clientes] == '0' ) {   header("location: denegado.php");  }
	...
	if (!isset($_SESSION['user_login_status']) AND $_SESSION['user_login_status'] != 1) {
        ...
        if($_GET[opc] == 1){
          ...
          $inserta = mysqli_query($cone,"INSERT INTO `cuentas_ordenantes` (`id`, `banco`, `cuenta`) 
          VALUES (NULL, '$ban','$cue');");

        header("location: cuentas_ordenantes.php");
...
<section class="content-header">
    ...
    <div class="card-header">
                <h3 class="card-title">Nueva Cuenta <href = "#" data-toggle="modal" data-target="#modal-xl"><img src="https://img.icons8.com/windows/32/000000/plus.png"/></a></h3>
              </div>
  ...
  <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `cuentas_ordenantes`");
                  ...
                  <form   id="form2" name="form2" action="cuentas_ordenantes.php" method="get" >
...
<div class="modal-body">
<div class="card-body">
<form   id="form1" name="form1" action="cuentas_ordenantes.php" method="get" >                 
<div class="row">
