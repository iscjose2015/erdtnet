...
<section class="content-header">
  ...
  <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php $peso = saber_peso($re['c_producto']);  echo $peso; ?></td>
                    <td><?php  echo $peso * $re['cantidad'];  $suma = $suma + ($peso * $re['cantidad']); ?></td>
  ...
  <p>Suma de Peso del Contenedor <?php echo $suma; ?></p>
