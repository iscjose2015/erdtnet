...
<section class="content-header">
  ...
  <tr>
    ...
    <td width="76%" valign="top"><p><strong><em><h1>Facturacion
            <img src="logo_fijaciones.png" width="122" height="55" /></h1>
    </em></strong>
  ...
  <table width="977"  class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `invoices` where estatus = 'Timbradas' order by id desc");
