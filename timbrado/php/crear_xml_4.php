...
$w->startAttribute('xmlns:catCFDI');
$w->text( "http://www.sat.gob.mx/sitio_internet/cfd/catalogos" );
$w->endAttribute();

$w->startAttribute('xmlns:cce11');
$w->text( "http://www.sat.gob.mx/ComercioExterior11" );
$w->endAttribute();


$w->startAttribute('xmlns:tdCFDI');
$w->text( "http://www.sat.gob.mx/sitio_internet/cfd/tipoDatos/tdCFDI" );
$w->endAttribute();
...
$w->writeAttribute('CondicionesDePago',"Contado");
...
$w->text( "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd http://www.sat.gob.mx/ComercioExterior11 http://www.sat.gob.mx/informacion_fiscal/factura_electronica/Documents/Complementoscfdi/ComercioExterior11.xsd" );
$w->endAttribute();	
...
$w->writeAttribute('ClaveUnidad',$re_detalle[unidad_sat]); // Clave unidad del Sat
