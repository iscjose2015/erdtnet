      ...
      if($re_consulta['facturas'] == '0' ) {   header("location: denegado.php");  }
        ...
        if($_GET['opc'] == 1){
          ...
          echo $fech_pago
            ...
            `uso`, `estatus`, `tipo_cfdi`, `folio`, `serie`, `hora`, `emisor`, `moneda`, `lugar`, `total`, `pedimento`, `relacionado`, `tiporelacionado`, `ordenante`, `beneficiario` , `fecha_pago` , `tipo_cambio`) 
            VALUES (NULL, '$fech', '', '$emi', '$for', '$met', 'P01', 'Por Emitir', '$tip', '', '$ser', '$hor','$emisor','$mon','$lug','$mont','$ped','$rel','$tipor','$ord','$ben','$fech_pago','$t_cambio')");
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
              ...
              $consulta = mysqli_query($cone, "SELECT * FROM `complementos` where emisor = '$empre' order by 1 desc");
            ...
            <div class="card-body">
              ...
              <form   id="form1" name="form1" action="complementos.php" method="get" >                 
                <div class="row">
                  ...
                  <div class="col-6">
                    <?php $consulta_proveedor = mysqli_query($cone,"SELECT * FROM `clientes` order by 2"); ?>
                    Receptor
                  ...
                  <div class="col-2">
                    Hora
                    <input type="text" class="form-control" id="txthora" placeholder="hora" name="txthora" value = "<?php echo date('G:i:s'); ?>" readonly required  >
                  </div><!--/.col-2-->
                  ...
                  <div class="col-2">
                    ...
                    <input type="text" class="form-control" id="txtmonto" placeholder="Monto" name="txtmonto"  value="0" required  readonly >
                  </div><!--/.col-2-->
