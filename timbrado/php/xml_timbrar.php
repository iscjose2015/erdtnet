...
<table width="72%" border="0" align="center">
  <tr>
    ...
    <td width="1%">&nbsp;</td>
     ...
     <?php if($error <> 1)  { ?>
    <td width="47%" align="center"><a href="https://elreydeltornillo.com/envio_correo_con_datos.php?idorden=<?php echo $cve; ?>">Enviar por Correo Electronico <img src="https://img.icons8.com/external-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto/32/000000/external-email-file-and-folder-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto.png"/></a></td>
	 <?php } ?>
