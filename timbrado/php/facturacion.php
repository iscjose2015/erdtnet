...
<section class="content-header">
    ...
    <div class="card-header">
                <h3 class="card-title">Factura <?php echo $_SESSION[tipo];?><a href = "#" data-toggle="modal" data-target="#modal-xl"><img src="https://img.icons8.com/windows/32/000000/plus.png"/></a></h3>
  ...
  <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `invoices`");
                  ...
                  <tr>
                    ...
                    <td><?php echo utf8_encode($re['estatus']); ?></td>
                    <td><a href="detalle_invoices.php?idorden=<?php echo $re[id]; ?>&serie=<?php echo $re[id]; ?>">Ver Detalle </a></td>
                  </tr>
...
<?php
$consulta_proveedor = mysqli_query($cone,"SELECT * FROM `clientes` order by 2");
...
<input type="text" class="form-control" id="txtpedimento" placeholder="Pedimento" name="txtpedimento"  value="" required  >
</div>
