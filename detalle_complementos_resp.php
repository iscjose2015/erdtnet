  ...
  $idorden = $_GET['idorden'];
        ...
        if($_GET['opc'] == 1){
          ...
          //  echo $importe_factura;
            ...
            // Actualiza el monto
             $nuevo_monto = $valor_factura_con_iva + $re_monto_anterior[total];
...
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="card-header">
      ...
      <div class="card-body">
        <?php
          $consulta2 = mysqli_query($cone, "SELECT * FROM `detalle_ordenes` where idorden = '$idorden';");
          $suma = 0;
        ...
        <table width="100%" border="1"><!--INICIA TABLE BOTON AGREGAR-->
          <tr>
            <td width="14%">
              ...
              ?>
                <a href="cancelar.php?folio_fiscal=<?php echo $re_orden['uuid']; ?>">
            ...
            <td width="29%" align="center">
              <?php 
                echo "<h4>Total: $".number_format($re_orden['total'],2)."</h4>";
              ?>
            </td>
        ...
        <div class="modal-body">
          ...
          <div class="row g-2"><!-- INICIA SECCION 1--->
            ...
            <div class="row g-2"><!-- INICIA SECCION 2--->
              ...
              <div class="col-sm-5 col-md-6">
                  <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Serie/Folio</label>
                      <div class="col-sm-9">
                      <input type="text" name="serieFolio" id="serieFolio" class="form-control" placeholder="SERIE/FOLIO" >
                      </div>
                  </div>
              </div>
