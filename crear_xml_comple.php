...
$w->startElementNS('cfdi','Complemento', null);
  $w->startElementNS('pago10','Pagos', null);
 ...
 // echo "Aqui".$ord.$ben;
  ...
  $w->startElementNS('pago10','Pago', null);
    ...
    $w->writeAttribute('Monto',$total_monto);
    ...
    $w->startElementNS('pago10','DoctoRelacionado', null);
    $w->writeAttribute('IdDocumento',$re_de[uuid]);
    $w->writeAttribute('Serie',"A");
    $w->writeAttribute('Folio',"59");
    $w->writeAttribute('MonedaDR',"MXN");
    $w->writeAttribute('MetodoDePagoDR',"PPD");
    $w->writeAttribute('NumParcialidad',"1");
    $w->writeAttribute('ImpSaldoAnt',"10.0");
    $w->writeAttribute('ImpPagado',"10.00");
    $w->writeAttribute('ImpSaldoInsoluto',"0.00");
    $w->endElement();//Fin de pago10 DoctoRelacionado
