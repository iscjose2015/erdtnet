  ...
  if($re_consulta[clientes] == '0' ) {   header("location: denegado.php");  }
	...
	if (!isset($_SESSION['user_login_status']) AND $_SESSION['user_login_status'] != 1) {
        ...
        if($_GET[opc] == 1){
            ...
            $inserta = mysqli_query($cone,"INSERT INTO `cuentas` (`id_cliente`, `nombre_cliente`, `telefono_cliente`, `email_cliente`, `direccion_cliente`, `colonia`, `ciudad`, `estado`, `cp`, `status_cliente`, `date_added`, `rfc`) 
...
<section class="content-header">
    ...
    <div class="card-header">
                <h3 class="card-title">Nueva Cuenta Bancaria<a href = "#" data-toggle="modal" data-target="#modal-xl"><img src="https://img.icons8.com/windows/32/000000/plus.png"/></a></h3>
              </div>
  ...
  <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `clientes`");
                  ...
                  <tr>
                    ...
                    <td><?php echo utf8_encode($re['email_cliente']); ?> </td>
