 ...
 <img src="<?php echo $imagen_empresa; ?>" width="122" height="55" /></h1>
  ...
  <table width="977"  class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `invoices` where estatus = 'Timbrada' and emisor = '$idempresa' order by id desc");
