<?php
  ...
  include("conecta_facturacion.php");
  $consulta_prod = mysqli_query($con,"SELECT * FROM `products` WHERE `codigo_producto` LIKE '5420300000'");
...
?>
  ...
  <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo utf8_encode($re['inicial']); ?></td>
                    <td>$<?php echo ($re['monto'] / 1000) * $re['cantidad']; ?></td>
                    <td>$<?php //echo //saber_peso("5420300000");?></td>
                    ...
                    <td></td>
                    <td><a href="por_partida.php">Ver Detalle de Partida</a></td>
