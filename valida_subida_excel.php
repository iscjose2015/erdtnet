     ...
     if ($ext[1] == 'xlsx' or $ext[1] == 'XLSX')
     {
        ...
        // echo "<br>";
         ...
         $padre = $_SESSION[padre];
           ...
           echo "Se ha subido correctamente el archivo: ".'<a href="phpexcel/index.php?arch='.$nom.'">clic aqui para continuar</a>';

           $idor = $_SESSION[orden];
         //  echo $nom;
      
           $actualiza = mysqli_query($cone,"UPDATE `ordenes` SET `documento` = '$nom' WHERE `ordenes`.`id` = '$idor';");
