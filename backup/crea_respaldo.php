...
function exportarTablas($host, $usuario, $pasword, $nombreDeBaseDeDatos)
{
    ...
    $nombreDelArchivo = sprintf('%s/respaldo_%s_%s.sql', $carpeta, $fecha, $time);

    $_SESSION['nombre_archi'] = $nombreDelArchivo;
...
$accion = exportarTablas("localhost", "ian", "Esteban7", "facturacion");


if  ($accion) { echo "se creo: ". $_SESSION['nombre_archi']; }


// mysqli_connect("localhost","ian","Esteban7","facturacion");