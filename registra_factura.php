...
<?php
  ...
  date_default_timezone_set('America/Mexico_City');
    ...
    Swal.fire({
      ...
      text: 'El numero de Factura que desea ingresar ya existe',  
      })
</script>"; 
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registro Factura de Compra</h1>
    ...
    <div class="card-header">
                <h3 class="card-title">Nueva Compra<a href = "#" data-toggle="modal" data-target="#modal-xl"><img src="https://img.icons8.com/windows/32/000000/plus.png"/></a></h3>
  ...
  <table id="example1" class="table table-bordered table-striped chica">
                  ...
                  <tbody>
                    ...
                    $consulta = mysqli_query($cone, "SELECT * FROM `facturas_prov` a INNER JOIN proveedores b ON a.id_provee = b.id order by id_factura desc");
                  ...
                  <tr class="chica">
                    ...
                    <a href ="registra_factura.php?cve=<?php  echo $re['id_factura']; ?>&opc=<?php echo '3'; ?>" id="borra"> <img src="https://img.icons8.com/fluency-systems-regular/18/null/delete-forever.png"/></a></td>
                    <td><a href="check.php?idorden=<?php echo "45";?>">Checa Match con Orden de Compra</a></td>
                     <?php } ?>
                  </tr>
