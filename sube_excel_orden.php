...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Subir Excel <img src="https://img.icons8.com/fluency/48/000000/microsoft-excel-2019.png"/></h1>
          </div>
          <div class="col-sm-6">
  ...
  <form action="valida_subida_excel.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
