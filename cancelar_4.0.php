...
// PAC:
//https://timbracfdi33.mx:1443/Timbrado.asmx?wsdl anterior
...
$consulta_emisor = mysqli_query($con,"SELECT emisor,b.empresa, b.rfc FROM `invoices` a 
...
$respuesta = $response->CancelaCFDI40Result->anyType[7];
...
$respuesta = $response->CancelaCFDI40Result->anyType[2];


if($respuesta == 'El comprobante será cancelado') //El comprobante será cancelado
        {
