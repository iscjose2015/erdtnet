              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td><a class="sub" onclick="modal_edit(<?php echo $re['id'];?>, 'empresa')"><img src="https://img.icons8.com/material-sharp/24/A83339/pencil--v2.png"/></a></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form   id="newIMG" name="form2" action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-2"><!-- INICIA SECCION 2--->
              ...
              <div class="col-sm-5 col-md-6">
                <div class="text-center">
                  <img src="dctos_rel/FIJACIONES INTERNACIONALES/logo_fijaciones.png" width="190" height="102" class="rounded" alt="...">
