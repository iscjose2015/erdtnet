              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $items[$k]['codproduct'];?></td>
                    <td><?php echo $items[$k]['nomproduct'];?></td>
                    <td><?php echo $items[$k]['idsat'];?></td>
                    <td><?php echo $items[$k]['nombsat'];?></td>
                    <td><?php echo $items[$k]['unidadsat'];?></td>
                    <td><?php echo $items[$k]['peso'];?></td>
                    <td><a class="sub" onclick="modal_edit(<?php echo $items[$k]['idproduct'];?>, 'up_product')"><img src="https://img.icons8.com/material-sharp/24/A83339/pencil--v2.png"/></a></td>
                  </tr>                 
                  <?php } ?>
                </tbody>
                <tfoot>
