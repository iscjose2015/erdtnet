...
<div class="d-flex card-header">
  ...
  <h5><i class="bi bi-pencil"></i> Editar Factura</h5>
  </div>
  ...
  <div class="card-body">
			...
			<div class="col-md-12">
					<div class="d-flex justify-content-md-end">
						...
						<div class="btn-group" role="group" aria-label="Basic example">
						  <button type="submit" class="btn btn-outline-secondary"><i class='bi bi-arrow-repeat'></i> Actualizar datos</button>
						  ...
						  <button type="button" class="btn btn-outline-secondary" onclick="imprimir_factura('<?php echo $id_factura;?>')"><i class='bi bi-printer-fill'></i> Imprimir</button>
						</div>
	...
	<script src="assets/dist/js/editar_factura.js"></script>
