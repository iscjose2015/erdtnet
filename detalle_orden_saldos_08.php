                    ...
                    <td  class="letrachica">
                          ...
                          <table width="1701" border="0" class="letrachica">
							    ...
							    ?>
                                    ...
                                    <td width="116" align="center"><?php  echo number_format($saldo_piezas,2);  ?></td>
                                    <td width="98" align="center">$<?php  echo ($saldo_piezas * $re[monto])/1000;  ?></td>
                                    <td width="90" align="center"><?php  echo $peso_uni * $saldo_piezas; ?></td>
                                    <td width="137" align="center">$<?php  echo  ($saldo_piezas * $re[monto])/1000;  ?></td>
                                    <td width="164" align="center">$<?php  echo  ($saldo_piezas * $re[monto])/1000;  
                               ...
                               // echo saber_factura($idf).": ".$re_cant['cantidad'];
                                ...
                                $suma_compras = $suma_compras + $re_cant['cantidad'];
                                  ...
                                  <tr>
                                    <td width="165" align="center"><?php  echo saber_factura($idf); $fa = saber_factura($idf);  ?></td>
                                        <td align="center" width="111">&nbsp;</td>
                                    <td width="144" align="center"><?php  echo saber_fecha($idf); ?></td>
                                    <td width="151" align="center"><?php   echo abs($re_cant['cantidad']);
									...
									?></td>
                                    <td width="180" align="center">$<?php  echo number_format(($re['monto'] * abs($re_cant['cantidad'])) / 1000 ,2);
?></td>
                                    ...
                                    <td width="116" align="center" bgcolor="<?php echo $color; ?>" >	<?php 
									...
									if ($negativo == 0) { $valor_saldo = 0; }
									 ...
									 ?></td>
                                    <td width="90" align="center"><?php  echo $peso_uni * abs($saldo_piezas); ?></td>
                                    <td width="137" align="center">$<?php echo $saldo_anterior; ?></td>
                                    <td width="164" align="center">$<?php
...
<table width="2296" border="0">
  <tr>
    ...
    <td width="64">&nbsp;</td>
    <td width="41">&nbsp;</td>
    <td width="152" align="right"><em><strong>Saldo Total: $</strong></em></td>
    <td width="175" align="center" valign="top"><em><strong>&nbsp;
